...
export const SocketProvider = ({ children }) => {
  ...
  useEffect(() => {
    if (isAuthenticated && user) {
      ...
      // Listen for certificate ready notifications
      newSocket.on('certificate-ready', async (data) => {
        console.log('🔔 Certificate ready notification received:', data);
        ...
        toast.success(data.message || 'Your certificate is ready!', {
          duration: 7000,
          icon: '📜',
          style: {
            background: '#10b981',
